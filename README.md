...
If the certificates expires, Cloud Signing ignores it and starts creating new development certificates on Apple portal. However, this creates
a new development certificate for every new build and soon we hit the limit for number of allowed certificates. This step prevents that by failing the build 
